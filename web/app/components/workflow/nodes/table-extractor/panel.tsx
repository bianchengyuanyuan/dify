...
import type { TableExtractorNodeType } from './types'
...
const i18nPrefix = 'workflow.nodes.TableExtractor'

const Panel: FC<NodePanelProps<TableExtractorNodeType>> = ({
  id,
  data,
}) => {
  const { t } = useTranslation()
  const { locale } = useContext(I18n)
  const link = useNodeHelpLink(BlockEnum.TableExtractor)
